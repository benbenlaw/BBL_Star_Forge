...
public class DataGenerators {
    ...
    public static void gatherData(GatherDataEvent event) {
        ...
        generator.addProvider(event.includeServer(), new LootTableProvider(packOutput, Collections.emptySet(),
                List.of(new LootTableProvider.SubProviderEntry(SFLootTables::new, LootContextParamSets.BLOCK)), event.getLookupProvider()));
        ...
        generator.addProvider(event.includeClient(), new SFLang(packOutput, event.getExistingFileHelper()));
